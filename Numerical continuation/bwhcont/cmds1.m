...
p=swibra('bwh3/UV','bpt3','bwh3/UH',-0.01); p.nc.dsmax=5.0;
...
p=loadp('bwh2/UV','bpt3','bwh2/UH'); %load from a pt in the in dir to an out dir
...
p=swibra('bwh3/UV','bpt2','bwh3/SP0',0.01); pause;
...
p.sw.bifcheck=2;  p.nc.dsmax=5.0;p=cont(p,168);
...
p=twswibrax('bwh3/UH',hp,20,kwnr,outb,aux); %branch switching from hopf point to travelling wave branch
