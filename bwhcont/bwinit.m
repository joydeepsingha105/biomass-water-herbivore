...
p.file.smod=100; % save each smod'th cont.step, large at init to save few data points, 
  % will be decreased for more interesting (patterned) branches 
p.sw.bifcheck=2; % bif.detection based on eigenvalues (not LU-decomp and det.)
